...
- [Mantra](https://mantra.gonewx.com) by [mantra-hq](https://github.com/mantra-hq) ([releases](https://github.com/mantra-hq/mantra-releases)) - Time-travel debugger for AI coding sessions. Replay, branch, and debug Claude Code conversations like a video timeline. Lets you rewind to any point, fork alternate paths, and compare session outcomes — great for understanding what went wrong or exploring "what if" scenarios.
