...
- [claude-handoff](https://github.com/REMvisual/claude-handoff) by [REMvisual](https://github.com/REMvisual) - Cross-session handoff system for Claude Code. Generates structured context summaries, tracks work chains across sessions, and integrates with beads for issue tracking. No more "where was I?" when starting a new session.
