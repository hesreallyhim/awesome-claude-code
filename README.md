...
- [cybersecurity-claude-skills](https://github.com/mahmutka/cybersecurity-claude-skills) by [mahmutka](https://github.com/mahmutka) - A hands-on cybersecurity suite of 4 skills covering offensive and defensive security: web hacking (OWASP Top 10, SQLi, XSS, SSRF, WAF bypass), pentest recon (OSINT, Shodan, subdomain enumeration, attack surface mapping), secure code review (Python/JS/Go/Java with CWE mapping and Semgrep), and CTF solver (crypto, pwn, reverse engineering, forensics).
