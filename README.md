...
- [LucidShark](https://github.com/toniantunovi/lucidshark) by [Toni Antunovic](https://github.com/toniantunovi) - "Ship AI-generated code without the fear." Unified code quality tool that consolidates linting, type checking, formatting, security scanning (SAST/SCA/IaC), testing, coverage analysis, and duplication detection into one tool. Local-first with MCP support for Claude Code, enabling AI agents to receive structured feedback and automatically fix quality issues. Supports 15 programming languages.
