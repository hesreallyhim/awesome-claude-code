...
- [Roampal](https://github.com/roampal-ai/roampal-core) by [roampal-ai](https://github.com/roampal-ai) - Outcome-based persistent memory for Claude Code. Two commands to install (`pip install roampal && roampal init`), then context is injected automatically via hooks and MCP. Good advice gets promoted across sessions, bad advice gets demoted.
