...
- [Upload-Post Skill](https://github.com/Upload-Post/upload-post-skill) by [Upload-Post](https://github.com/Upload-Post) - AI agent skill for uploading content to 10+ social media platforms (TikTok, Instagram, YouTube, LinkedIn, Facebook, X, Threads, Pinterest, Reddit, Bluesky). Supports cross-posting, scheduling, FFmpeg media processing, and analytics retrieval via the Upload-Post API.
