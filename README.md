...
- [LinkedIn Automation Skill](https://github.com/Linked-API/linkedin-skills/tree/main/linkedin) by [Linked API](https://github.com/Linked-API) - CLI-based LinkedIn automation skill that wraps the `@linkedapi/linkedin-cli` npm package. Fetch profiles, search people and companies, send messages and InMails, manage connections, create posts, react, comment, and use Sales Navigator. Each command runs a real cloud browser via Linked API infrastructure.
