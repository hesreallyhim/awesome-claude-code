...
- [Google Ads Keyword Segmentation](https://github.com/AmanPHashim/google-ads-keyword-segmentation) by [Aman Hashim](https://github.com/AmanPHashim) - Transforms raw Google Ads Keyword Planner exports into campaign-ready structures. Filters irrelevant keywords, segments into 10-15 campaigns, marks top recommended keywords per campaign, and generates a formatted Excel workbook with a phased strategy report.
