...
- [mcp-gateway](https://github.com/MikkoParkkola/mcp-gateway) by [Mikko Parkkola](https://github.com/MikkoParkkola) - Universal MCP gateway in Rust with Meta-MCP pattern (4 tools → 100+ dynamically), providing ~95% context token savings. Features circuit breakers, rate limiting, and 42 starter API capabilities. Single binary, works with any MCP client.
