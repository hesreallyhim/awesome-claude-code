...
- [EUrouter Integration](https://github.com/EUrouter/eurouter-skill) by [EUrouter](https://github.com/EUrouter) - AI coding assistant skill for integrating EUrouter, an OpenAI-compatible AI gateway built for EU/GDPR compliance. Covers drop-in migration from OpenAI/OpenRouter, EU data residency configuration, all API endpoints (chat completions, embeddings, streaming, tool calling, vision), and multi-model fallback routing.
