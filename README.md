...
- [OpenClaw Smart Router](https://github.com/AtlasPA/openclaw-smart-router) by [AtlasPA](https://github.com/AtlasPA) - Intelligent model selection for OpenClaw agents that automatically routes to optimal models based on task complexity, budget constraints, and learned patterns. Features 4-factor weighted scoring, pattern learning after 5+ similar tasks, and cost tracking with savings analysis vs. baseline.
