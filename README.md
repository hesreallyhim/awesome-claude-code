...
- [YC/SV Development Framework](https://github.com/founderjourney/yc-sv-development-framework) by [founderjourney](https://github.com/founderjourney) - Decision-making framework for software development based on principles from Paul Graham, Sam Altman, Michael Seibel, Patrick Collison, and Brian Chesky. Includes prioritization system (P0/P1/P2/NEVER), technical debt guidelines, and quick decisions for tests, refactoring, and CI/CD.
