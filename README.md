...
- [GolemBot](https://github.com/0xranx/golembot) by [0xRanx](https://github.com/0xranx) - A unified AI assistant framework that wraps multiple Coding Agent CLIs (Claude Code, Cursor, OpenCode, Codex) behind a single API. Features a Skill system, IM channel adapters (Feishu/Slack/Telegram/Discord), fleet mode for running multiple bots, and an interactive onboard wizard.
