...
- [claude-code-voicevox-notify](https://github.com/moto-pu/claude-code-voicevox-notify) by [moto-pu](https://github.com/moto-pu) - VOICEVOX voice notifications for Claude Code on WSL2 + Windows. Provides audio alerts for task completion and input waiting, auto-extracts issue numbers from git branch names, and supports both Japanese and English messages.
