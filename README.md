...
- [claude-ai-models](https://github.com/Tontoon7/claude-ai-models) by [Tontoon7](https://github.com/Tontoon7) - Fetches the latest AI model IDs from Anthropic, OpenAI & Google so Claude always uses up-to-date model names in code. No API keys needed.
