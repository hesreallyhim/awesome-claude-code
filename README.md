...
- [Claude Code on Android](https://github.com/ferrumclaudepilgrim/claude-code-android) by [FerrumClaudePilgrim](https://github.com/ferrumclaudepilgrim) - Complete guide for running Claude Code natively on Android with Termux. Two install paths (native Termux + proot-distro Ubuntu), 14-entry troubleshooting reference, diagnostic skills, and verification test suite. Verified on three devices.
