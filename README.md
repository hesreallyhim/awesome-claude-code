...
- [ScreenHand](https://github.com/manushi4/Screenhand) by [Clazro](https://github.com/manushi4) - Native desktop + browser automation MCP server with 82 tools. Gives Claude Code eyes and hands on the desktop via macOS/Windows accessibility APIs and Chrome DevTools Protocol. Includes anti-detection, memory, jobs, supervisor, and reusable playbooks for 10 platforms.
