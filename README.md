...
- [Pi Builder](https://github.com/arosstale/pi-builder) by [arosstale](https://github.com/arosstale) - Local-first WebSocket gateway that routes coding prompts to 11 CLI agents (pi, claude, aider, codex, gemini, goose, and more) with automatic capability-based routing and fallback. Features Agent Teams (7 presets), thread-based engineering, RPC sessions, PTY terminal multiplexer with ghostty-web, and a single-file browser UI.
- [sudocode](https://github.com/sudocode-ai/sudocode) by [ssh-randy](https://github.com/ssh-randy) - Lightweight agent orchestration dev tool that lives in your repo. Integrates with various specification frameworks. It's giving Jira.
