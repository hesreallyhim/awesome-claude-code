...
- [Synod](https://github.com/quantsquirrel/claude-synod-debate) by [quantsquirrel](https://github.com/quantsquirrel) - Research-backed multi-agent deliberation system where Claude, Gemini, and OpenAI models debate and deliberate for better decision-making. Grounded in 5 academic papers covering deliberative democracy, ensemble methods, and multi-agent systems.
