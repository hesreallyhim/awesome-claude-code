...
- [claude-cost-optimizer](https://github.com/Sagargupta16/claude-cost-optimizer) by [Sagar Gupta](https://github.com/Sagargupta16) - Save 30-60% on Claude Code costs with proven strategies, real benchmarks, copy-paste CLAUDE.md templates, and Python tools for token estimation and usage analysis. Covers API, Bedrock, and Vertex AI pricing.
