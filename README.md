...
- [Creative Director Skill](https://github.com/smixs/creative-director-skill) by [Sergey Shima](https://github.com/smixs) - AI creative director with recursive self-assessment. 20+ methodologies (SIT, TRIZ, Bisociation, SCAMPER, Synectics), 3-axis evaluation calibrated against Cannes/D&AD/HumanKind, 5-phase creative process from brief intake to final presentation. Includes 6 storytelling frameworks, 7 insight mining techniques, and anti-score-inflation rules.
