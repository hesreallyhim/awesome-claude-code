...
- [Conduit](https://github.com/bkauto3/Conduit) by [bkauto3](https://github.com/bkauto3) - Headless browser MCP server with SHA-256 hash-chained audit trails and Ed25519-signed proof bundles. Stealth Chromium (Patchright), built-in web search, BFS crawling, page fingerprinting, and self-verifiable proof export. Part of the SwarmSync.ai agent ecosystem.
