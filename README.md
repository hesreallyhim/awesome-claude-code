...
- [claude-skill-notepad](https://github.com/crfgxr/claude-skill-notepad) by [crfgxr](https://github.com/crfgxr) - Opens a notepad.md file in a vertical iTerm2 split for your current project. Supports nano (default) and vim editors. Auto-creates a structured template on first run.
