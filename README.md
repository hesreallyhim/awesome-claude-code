...
- [claude-code-recipes](https://github.com/Sagargupta16/claude-code-recipes) by [Sagar Gupta](https://github.com/Sagargupta16) - 50+ copy-paste recipes for Claude Code — ready-to-use commands, subagents, hooks, skills, MCP configs, and end-to-end workflows that work out of the box.
