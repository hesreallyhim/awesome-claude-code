...
- [IDE Agent Kit](https://github.com/ThinkOffApp/ide-agent-kit) by [ThinkOffApp](https://github.com/ThinkOffApp) - Lightweight coordination layer that lets IDE-based AI agents (Claude Code, Codex, Cursor) participate in team workflows. Includes a webhook relay for receiving tasks, a tmux session runner for execution, and append-only receipt logs for audit trails.
