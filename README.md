...
- [Geepers](https://github.com/lukeslp/geepers) by [Luke Steuber](https://github.com/lukeslp) - 72 specialized agents for Claude Code spanning accessibility, performance, deployment, corpus linguistics, and more. Install with `/plugin add lukeslp/geepers`.
