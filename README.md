...
- [Motif](https://github.com/Bulugulu/motif-cli) by [Aviv Sheriff](https://github.com/Bulugulu) - Analyzes your Cursor and Claude Code conversations to discover recurring workflows, correction-derived rules, and communication patterns. Generates personalized CLAUDE.md, .cursorrules, and skill files tuned to how you actually work. Also produces an Agentic Coding Assessment tracking your growth over time. Local-only, no API keys.
