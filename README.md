...
- [Evos Operational Domain Skills](https://github.com/ai-evos/agent-skills) by [Evos](https://github.com/ai-evos) - 8 eval-verified operational domain skills codifying 15+ years of real industry expertise across logistics (freight exceptions, carrier management, customs compliance), retail (inventory planning, returns processing), manufacturing (production scheduling, quality non-conformance), and energy (procurement strategies). Each skill includes deep reference materials and automated eval suites. 93.2% average eval score across 201 scenarios.
