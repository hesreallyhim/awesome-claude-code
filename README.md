...
- [agentskill.sh](https://agentskill.sh) by [agentskill-sh](https://github.com/agentskill-sh) - A searchable directory of 44k+ skills for Claude Code, Cursor, Codex, and 10+ agents. Features two-layer security scanning across 12 threat categories and one-command installation via the `/learn` skill.
