...
- [Geepers](https://github.com/lukeslp/geepers) by [Luke Steuber](https://github.com/lukeslp) - 72 specialized development agents for Claude Code spanning accessibility, performance, deployment, corpus linguistics, and more. Ships as a Claude Code plugin (`/plugin add lukeslp/geepers`) and a Python package on PyPI.
