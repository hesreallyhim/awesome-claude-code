...
- [cc-statistics](https://github.com/androidZzT/cc-statistics) by [androidZzT](https://github.com/androidZzT) - Three-in-one Claude Code stats tool: CLI, Web dashboard, and native macOS SwiftUI menu bar panel. Tracks token costs by model, code changes by language, AI-vs-human time split, efficiency scoring (S/A/B/C/D), and generates weekly/monthly Markdown reports. Also supports Codex and Cursor data sources. Zero third-party dependencies.
