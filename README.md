...
- [mcp-interactive-terminal](https://github.com/amol21p/mcp-interactive-terminal) by [amol21p](https://github.com/amol21p) - Real interactive terminal sessions for REPLs, SSH, database clients, and any interactive CLI — with clean text output, smart completion detection, and multi-layer security. Install: `claude mcp add terminal -- npx -y mcp-interactive-terminal`.
