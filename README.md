...
- [OctoAlly](https://github.com/ai-genius-automations/octoally) by [AI Genius Automations](https://github.com/ai-genius-automations) - Local-first orchestration dashboard for Claude Code and RuFlo. Multi-agent hive-mind sessions, live-streaming grid view, tmux session persistence, Whisper voice dictation, built-in git source control, and an Electron desktop app. One-liner install.
