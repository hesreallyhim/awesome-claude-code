...
- [radius](https://github.com/bluzir/radius) by [bluzir](https://github.com/bluzir) - Deterministic security layer for AI agents with Claude Code hooks integration. Intercepts every tool call and enforces path checks, command guards, rate limits, and output DLP before execution. No LLM in the decision loop.
