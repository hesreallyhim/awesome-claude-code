...
- [Claude Scientific Skills](https://github.com/K-Dense-AI/claude-scientific-skills) by [K-Dense](https://github.com/K-Dense-AI/) - "A set of ready-to-use Agent Skills for research, science, engineering, analysis, finance and writing." That's their description - modest, simple. That's how you can tell this is really one of the best skills repos on GitHub. If you've ever thought about getting a PhD... just read all of these documents instead. Also I think it IS an AI agent or something? Awesome.
- [CN Content Matrix](https://github.com/fullstackcrew-alpha/skill-cn-content-matrix) by [fullstackcrew-alpha](https://github.com/fullstackcrew-alpha) - Chinese multi-platform content generator for Xiaohongshu, WeChat, Douyin, Bilibili with true style transfer.
...
- [Cost Optimizer](https://github.com/fullstackcrew-alpha/skill-cost-optimizer) by [fullstackcrew-alpha](https://github.com/fullstackcrew-alpha) - Save 60-80% on AI token costs with smart model routing, context compression, and heartbeat tuning.
- [DevOps Agent](https://github.com/fullstackcrew-alpha/skill-devops-agent) by [fullstackcrew-alpha](https://github.com/fullstackcrew-alpha) - One-click deploy, monitoring setup, scheduled backups, fault diagnosis with safety-first design.
...
- [Overnight Worker](https://github.com/fullstackcrew-alpha/skill-overnight-worker) by [fullstackcrew-alpha](https://github.com/fullstackcrew-alpha) - Autonomous overnight work agent. Assign tasks before sleep, get structured results by morning.
...
- [Smart PR Review](https://github.com/fullstackcrew-alpha/skill-smart-pr-review) by [fullstackcrew-alpha](https://github.com/fullstackcrew-alpha) - Opinionated AI code reviewer with 6-layer deep review, Devil's Advocate mode, MUST FIX/SHOULD FIX/SUGGESTION output.
