...
- [AppDeploy](https://github.com/AppDeploy-AI/skills) by [AppDeploy](https://appdeploy.ai) - Chat-native deployment skill that deploys apps with frontend, backend, cron jobs, database, file storage, AI capabilities, auth, and notifications, and gives you a live public URL instantly.
