...
- [ClaudeScope](https://github.com/q1uf3ng/claude-scope) by [q1uf3ng](https://github.com/q1uf3ng) - Local-first DevTools for Claude API and Claude Code. Acts as a transparent proxy — just set `ANTHROPIC_BASE_URL` and get a real-time timeline, cost dashboard, token usage breakdown, context window visualization, and session export. All data stored locally in SQLite, no telemetry. `npx @q1uf3ng/claude-scope`
