...
- [Tokscale](https://github.com/junhoyeo/tokscale) by [Junho Yeo](https://github.com/junhoyeo) - CLI tool for tracking token usage from Claude Code and other coding agents (OpenCode, OpenClaw/Moltbot, Codex, Gemini CLI, Cursor IDE, AmpCode, Factory Droid). Features a global leaderboard and 2D/3D contribution graphs.
