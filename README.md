...
- [agent-manager](https://github.com/fractalmind-ai/agent-manager-skill) by [fractalmind-ai](https://github.com/fractalmind-ai) - tmux + Python agent lifecycle manager for running multiple CLI AI agents (start/stop/monitor/assign) with cron-friendly scheduling; no server required.
