...
- [Production Grade](https://github.com/nagisanzenin/claude-code-production-grade-plugin) by [nagisanzenin](https://github.com/nagisanzenin) - 14-agent autonomous pipeline from idea to production-ready SaaS. Two-wave parallel execution, Polymath co-pilot, brownfield-safe. One install, 3 approval gates, everything else is autonomous.
- [sudocode](https://github.com/sudocode-ai/sudocode) by [ssh-randy](https://github.com/ssh-randy) - Lightweight agent orchestration dev tool that lives in your repo. Integrates with various specification frameworks. It's giving Jira.
