...
- [Crypto Trading Desk](https://github.com/hugoguerrap/crypto-claude-desk) by [Hugo Guerra](https://github.com/hugoguerrap) - Multi-agent cryptocurrency intelligence system with 7 specialized AI agents, 65+ MCP tools across 5 exchanges, cognitive learning from trades, and self-evolving platform capabilities. Includes market monitoring, technical analysis, risk management, news sentiment, and portfolio management with paper trading. Zero orchestration code — all coordination is pure Markdown.
