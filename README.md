...
- [Pinchwork](https://github.com/anneschuth/pinchwork) by [Anne Schuth](https://github.com/anneschuth) - Agent-to-agent task marketplace MCP server. Delegate tasks to specialized agents, discover available work, and deliver results — enabling multi-agent collaboration via the A2A protocol.
