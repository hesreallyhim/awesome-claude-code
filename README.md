...
- [tidal-cli](https://github.com/lucaperret/tidal-cli) by [Luca Perret](https://github.com/lucaperret) - Control Tidal music streaming from Claude Code. Available as both a CLI and a remote MCP server with 32 tools for searching the catalog, managing playlists, playing tracks, and discovering artists. Every command outputs JSON for agent automation. Uses the official Tidal API with OAuth PKCE authentication.
