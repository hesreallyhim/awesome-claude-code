...
- [GhostClaw](https://github.com/b1rdmania/ghostclaw) by [b1rdmania](https://github.com/b1rdmania) - An AI agent that lives on your machine and works for you. Message it on Telegram like a co-worker. Built on Claude Code and the Agent SDK. Bare metal, no containers, no cloud - 10 minutes to set up.
