...
- [OilOil UI/UX Guide](https://github.com/oil-oil/oiloil-ui-ux-guide) by [oil-oil](https://github.com/oil-oil) - A modern, clean UI/UX guidance and review skill with two modes: `guide` for actionable do/don't rules and `review` for prioritized P0/P1/P2 fix lists. Covers CRAP principles (Contrast/Repetition/Alignment/Proximity), task-first UX, cognitive load control, HCI laws, and interaction psychology. Enforces modern minimal style with no emoji icons.
