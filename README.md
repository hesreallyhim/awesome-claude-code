...
- [Claude Code Ops Starter](https://github.com/yurukusa/claude-code-ops-starter) by [yurukusa](https://github.com/yurukusa) - Production-tested hooks for autonomous Claude Code sessions: context window monitoring with staged warnings, autonomous decision enforcement, auto-syntax-checking after every edit, and destructive command guards. Built from 200+ hours of real autonomous operation. Includes one-command installer and CLAUDE.md template.
