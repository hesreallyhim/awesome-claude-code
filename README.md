...
- [chainaware-behavioral-prediction](https://github.com/ChainAware/behavioral-prediction-mcp) by [ChainAware] (https://github.com/chainAware/) - ChainAware Skill for AI-powered tools to analyze wallet behaviour prediction,fraud detection and rug pull prediction.
