...
- [AI Agent Production Checklist](https://github.com/tangcruz/ai-agent-production-checklist) by [Cruz Tang](https://github.com/tangcruz) - A 10-point production checklist for running AI agents 24/7, extracted from 3 months of operating 10+ Claude Code agents. Includes a production-grade CLAUDE.md template (SOUL.md identity, 4-layer memory tower, error loop detection, multi-agent isolation), a self-healing sentinel daemon with exponential backoff and flap detection, and operational patterns for daily agent lifecycle management. [Full system available at thinker.cafe](https://thinker.cafe).
